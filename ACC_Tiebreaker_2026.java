...
public class ACC_Tiebreaker_2026 { 
    public static void main(String[] args) {
        ...
        System.out.println("This program is designed to break ties between teams in the ACC.");
    ...
    private static void rank_com_opps(ArrayList<String> com_opps, int com_num, ArrayList<Integer> com_wins) {
        ...
        if (!check()) {
            System.out.println("The conference strength of schedule tiebreaker is skipped due to being replaced.");
            SportSource();
        }
        input.close();
    }
